...
function Invoke-SelfTest {
    ...
    $result = [pscustomobject]@{ Product='TrackerRadar Control'; Version='0.5.3-alpha'; Passed=@($checks | Where-Object {$_.Passed}).Count; Failed=@($checks | Where-Object {-not $_.Passed}).Count; Checks=$checks }
