...
Remove-Item $selfOut,$guiOut,$guiErr -Force -ErrorAction SilentlyContinue
...
$result = [pscustomobject]@{
    ...
    OverallPassed = ($self.ExitCode -eq 0 -and $alive -and [string]::IsNullOrWhiteSpace($errorText))
}
